package com.example.word_ocean_dictionary.db;
...
import com.example.word_ocean_dictionary.bean.ChengyuBean;
import com.example.word_ocean_dictionary.bean.PinBuWordBean;
import com.example.word_ocean_dictionary.bean.WordBean;
...
//                调用单个对象插入的方法
    ...
    public static List<PinBuWordBean.ResultBean.ListBean>queryPyWordFromPywordtb(String py,int page,int pagesize){
        ...
        while (cursor.moveToNext()) {
            ...
            @SuppressLint("Range") String zi = cursor.getString(cursor.getColumnIndex("zi"));
            @SuppressLint("Range") String py1 = cursor.getString(cursor.getColumnIndex("py"));
            @SuppressLint("Range") String wubi = cursor.getString(cursor.getColumnIndex("wubi"));
            @SuppressLint("Range") String pinyin = cursor.getString(cursor.getColumnIndex("pinyin"));
            @SuppressLint("Range") String bushou = cursor.getString(cursor.getColumnIndex("bushou"));
            @SuppressLint("Range") String bihua = cursor.getString(cursor.getColumnIndex("bihua"));
...
//        将集合转化成字符串类型进行插入
    ...
    public static WordBean.ResultBean queryWordFromWordtb(String word){
        ...
        if (cursor.moveToFirst()) {
            ...
            @SuppressLint("Range") String bushou = cursor.getString(cursor.getColumnIndex("bushou"));
            @SuppressLint("Range") String bihua = cursor.getString(cursor.getColumnIndex("bihua"));
            @SuppressLint("Range") String jijie = cursor.getString(cursor.getColumnIndex("jijie"));
            @SuppressLint("Range") String xiangjie = cursor.getString(cursor.getColumnIndex("xiangjie"));
    ...
    public static ChengyuBean.ResultBean queryCyFromCyutb(String cyu){
        ...
        if (cursor.moveToFirst()) {
            @SuppressLint("Range") String chengyu = cursor.getString(cursor.getColumnIndex("chengyu"));
            @SuppressLint("Range") String bushou = cursor.getString(cursor.getColumnIndex("bushou"));
            @SuppressLint("Range") String head = cursor.getString(cursor.getColumnIndex("head"));
            @SuppressLint("Range") String pinyin = cursor.getString(cursor.getColumnIndex("pinyin"));
            @SuppressLint("Range") String chengyujs = cursor.getString(cursor.getColumnIndex("chengyujs"));
            @SuppressLint("Range") String from_ = cursor.getString(cursor.getColumnIndex("from_"));
            @SuppressLint("Range") String example = cursor.getString(cursor.getColumnIndex("example"));
            @SuppressLint("Range") String yufa = cursor.getString(cursor.getColumnIndex("yufa"));
            @SuppressLint("Range") String ciyujs = cursor.getString(cursor.getColumnIndex("ciyujs"));
            @SuppressLint("Range") String yinzhengjs = cursor.getString(cursor.getColumnIndex("yinzhengjs"));
            @SuppressLint("Range") String tongyi = cursor.getString(cursor.getColumnIndex("tongyi"));
            @SuppressLint("Range") String fanyi = cursor.getString(cursor.getColumnIndex("fanyi"));
