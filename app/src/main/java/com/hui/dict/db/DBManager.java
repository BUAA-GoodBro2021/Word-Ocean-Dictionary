...
//     * 插入了多个对象所在的集合
//     * */
//    public static void insertListToPywordtb(List<ZiBean>list){
//        if (list.size()>0) {
//            for (int i = 0; i < list.size(); i++) {
////                获取集合当中的每一个bean对象
//                ZiBean bean = list.get(i);
////                调用单个对象插入的方法
//                try {
...
//     * 插入一个对象的方法
//     * */
//    public static void insertWordToPywordtb(ZiBean bean){
//        ContentValues values = new ContentValues();
//        values.put("id",bean.getId());
//        values.put("zi",bean.getZi());
//        values.put("bushou",bean.getBushou());
//        for(int i = 0;i < bean.getPinyin_origin().size(); i++){
//            values.put("py", bean.getPinyin_origin().get(i));
//            values.put("pinyin", bean.getPinyin().get(i));
